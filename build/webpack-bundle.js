...
(0, _reactDom.render)(_react2.default.createElement(_app2.default, null), document.getElementById('place_list'));
...
var _submit = __webpack_require__(29);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function addItem(item) {
      var arr = this.state.pageList.concat([item]);
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_submit2.default, { addItem: this.addItem }),
        _react2.default.createElement(_list2.default, { pageList: this.state.pageList, removeItem: this.removeItem })
      );
    }
  }]);
...
var List = function (_Component) {
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var renderedList = this.props.pageList.map(function (obj, i) {
        var curDate = Date(obj.createdAt).toString();
        return _react2.default.createElement(
          'li',
          { key: i, onClick: function onClick() {
              _this2.props.removeItem(obj.value);
            } },
          obj.value,
